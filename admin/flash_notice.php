    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-col text-center w-full mb-5">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-blue-600">ធ្វើបច្ចុប្បន្នភាពការជូនដំណឹង</h1>
                <p class="text-sm md:text-base lg:w-2/3 mx-auto leading-relaxed text-base">

                បង្កើនការចូលរួមរបស់អ្នកប្រើប្រាស់នៅលើគេហទំព័រដោយកែសម្រួលការជូនដំណឹងពន្លឺ ដើម្បីបញ្ជូនព័ត៌មានសំខាន់ៗ។ ធ្វើបច្ចុប្បន្នភាពសារទាំងនេះយ៉ាងរលូន ដើម្បីបង្កើតបទពិសោធន៍អ្នកប្រើប្រាស់ថាមវន្ត និងអន្តរកម្ម ដោយធានាថាទស្សនិកជនរបស់អ្នកនៅតែទទួលបានព័ត៌មាន និងចូលរួមជាមួយព័ត៌មានថ្មីៗ និងការប្រកាសចុងក្រោយបំផុត។
                </p>
            </div>
        </div>
    </section>
